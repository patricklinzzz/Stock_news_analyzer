...
GENERIC_WORD_BLOCKLIST = {
    ...
    "台南",  # 台南(1473) vs. 台南這個城市地名
    "新興",  # 新興(2605) vs. "新興市場"、"新興亞洲"這種總經名詞
    "全國",  # 全國(9937) vs. "全國經濟活動指數"這種當形容詞用的情況
    "可成",  # 可成(2474) vs. "可以成為"被切成"可成"+"為"的巧合拼字
    "佳龍",  # 佳龍(9955) vs. 政治人物"林佳龍"的名字後兩字
    "大華",  # 大華(9905) vs. "大華銀"(新加坡大華銀行UOB)撞名
    "美亞",  # 美亞(2020) vs. 證據模糊,疑似"美國-亞洲"的簡稱,無乾淨案例
    "信義",  # 信義(9940) vs. 台北信義區這個超知名地標地名,未來誤判風險太高
}
